...
export class FlyingEnemy extends Enemy {
  name = 'pterodactyl';
  // sound = SOUNDS['pterodactyl'];
  sound = new Audio('/flintstones/sounds/pterodactyl.mp3');
  image = new Image();
  width = 150;
  height = 100;
  maxFrame = 1;
  ...
  constructor(game: Game) {
    super(game);
    this.image.src = '/flintstones/images/pterodactyl.png';
...
export class GroundEnemy extends Enemy {
  ...
  sound = new Audio('/flintstones/sounds/dino.mp3');
  image = new Image();
  width = 150;
  height = 90;
  maxFrame = 1;
  ...
  constructor(public game: Game) {
    super(game);
    this.image.src = '/flintstones/images/dino.png';
...
export class JumpingEnemy extends Enemy {
  ...
  sound = new Audio('/flintstones/sounds/dragon.mp3');
  image = new Image();
  width = 300;
  height = 225;
  maxFrame = 1;
  ...
  constructor(game: Game) {
    super(game);
    this.image.src = '/flintstones/images/dragon_kid.png';
    this.speedX = 0;
