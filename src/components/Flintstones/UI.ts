...
export class UI {
  private imageLives = new Image();
  private imageLivesEmpty = new Image();
  private imageShild = new Image();
  private imageShildEmpty = new Image();
  private imagePower = new Image();
  private imageNumbers = new Image();
  private imageSkills = new Image();
  private imagePiggy = new Image();
  private imageMac = new Image();
  private tablo = new Image();
  ...
  constructor(public game: Game) {
    this.imageLives.src = `/flintstones/images/${IMAGE_LIVES}.png`;
    this.imageLivesEmpty.src = `/flintstones/images/${IMAGE_LIVES_EMPTY}.png`;
    this.imageShild.src = `/flintstones/images/${IMAGE_POW}.png`;
    this.imageShildEmpty.src = `/flintstones/images/${IMAGE_POW_EMPTY}.png`;
    this.imagePower.src = `/flintstones/images/${IMAGE_POWER}.png`;
    this.imageNumbers.src = `/flintstones/images/${IMAGE_NUMBERS}.png`;
    this.imageSkills.src = `/flintstones/images/${IMAGE_SKILLS}.png`;
    this.imagePiggy.src = `/flintstones/images/${IMAGE_PIGGY}.png`;
    this.imageMac.src = `/flintstones/images/${IMAGE_MAC}.png`;
    this.tablo.src = `/flintstones/images/${IMAGE_TABLO}.png`;
  }
  ...
  draw(context: CanvasRenderingContext2D) {
    ...
    this.messageFirstProgram(context);
  ...
  messageFirstProgram(context: CanvasRenderingContext2D): void {
    if (this.game.program1 && !this.game.graduate) {
      context.font = `${FONT_SIZE}px ${FONT_FAMILY}`;
